...
QT_MOC_LITERAL(8, 131, 30) // "AnonymizeDixicoinAmountChanged"
    ...
    "AnonymizeDixicoinAmountChanged"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->AnonymizeDixicoinAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::AnonymizeDixicoinAmountChanged)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void OptionsModel::AnonymizeDixicoinAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
