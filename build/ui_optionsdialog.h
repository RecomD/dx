...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeDixicoin = new QSpinBox(tabMain);
        anonymizeDixicoin->setObjectName(QStringLiteral("anonymizeDixicoin"));
        anonymizeDixicoin->setMinimum(2);
        anonymizeDixicoin->setMaximum(10000);
        anonymizeDixicoin->setSingleStep(10);
        anonymizeDixicoin->setValue(1000);

        gridLayout->addWidget(anonymizeDixicoin, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Dixicoin after logging in to the system.", nullptr));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Dixicoin on system login", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Dixicoin to keep anonymized", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", nullptr));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Dixicoin client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", nullptr));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Dixicoin network through a SOCKS5 proxy (e.g. when connecting through Tor).", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Dixicoin.", nullptr));
#endif // QT_NO_TOOLTIP
