...
public:
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "Dixicoin Node Count:", nullptr));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "Dixicoin Network", nullptr));
